...
public class MaterialProgressDrawable extends Drawable implements Animatable {
	...
	private void setUp(final double diameter) {
        final int shadowYOffset = HPDisplayUtil.convertDIP2PX(MyApplication.instance, Y_OFFSET);
        final int shadowXOffset = HPDisplayUtil.convertDIP2PX(MyApplication.instance, X_OFFSET);
        int mShadowRadius = HPDisplayUtil.convertDIP2PX(MyApplication.instance, SHADOW_RADIUS);
